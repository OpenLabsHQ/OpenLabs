...
class TestUsersAuth:
    ...
    async def test_update_aws_credentials(self, auth_api_client: AsyncClient) -> None:
    ...
    async def test_update_azure_credentials(self, auth_api_client: AsyncClient) -> None:
        ...
        assert (
            azure_response.json()["message"] == "Azure credentials updated successfully"
        )
    ...
    async def test_both_provider_credentials_status(

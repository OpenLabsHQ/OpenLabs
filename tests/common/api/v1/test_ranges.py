...
class TestRangesAuth:
    """Test suite for /ranges endpoints using the authenticated client fixture."""

    async def test_deploy_without_valid_enc_key(
    ...
    async def test_deploy_without_valid_range_blueprint(
        ...
        random_id = random.randint(-666, -69)  # noqa: S311
    ...
    async def test_deploy_without_valid_private_key(
        self, auth_api_client: AsyncClient
    ) -> None:
    ...
    async def test_destroy_with_invalid_id(self, auth_api_client: AsyncClient) -> None:
    ...
    async def test_get_range_details_non_existent(
        self, auth_api_client: AsyncClient
    ) -> None:
...
class TestRangesNoAuth:
    """Test suite for /ranges endpoints using the UNauthenticated client fixture."""

    async def test_deploy_without_enc_key(self, api_client: AsyncClient) -> None:
    ...
    async def test_destroy_without_enc_key(self, api_client: AsyncClient) -> None:
    ...
    async def test_get_range_headers_empty_list(self, api_client: AsyncClient) -> None:

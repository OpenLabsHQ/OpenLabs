...
async def test_blueprint_vpc_get_all_empty_list(api_client: AsyncClient) -> None:
...
async def test_blueprint_subnet_get_all_empty_list(api_client: AsyncClient) -> None:
...
async def test_blueprint_host_get_all_empty_list(api_client: AsyncClient) -> None:
...
async def test_blueprint_range_get_non_empty_list(api_client: AsyncClient) -> None:
...
async def test_blueprint_vpc_get_non_empty_list(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_host_get_non_empty_list(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_range_valid_payload(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_range_get_range_invalid_id(
    ...
    response = await auth_api_client.get(f"{BASE_ROUTE}/blueprints/ranges/{random_str}")
...
async def test_blueprint_range_invalid_vpc_cidr(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_range_overlap_vpc_cidr(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_range_empty_tag(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_range_invalid_provider(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_range_invalid_hostname(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_range_get_range(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_range_delete(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_range_delete_invalid_id(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_ramge_delete_non_existent(
    auth_api_client: AsyncClient,
) -> None:
...
async def test_blueprint_vpc_valid_payload(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_vpc_valid_multi_payload(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_vpc_get_vpc_invalid_id(auth_api_client: AsyncClient) -> None:
    ...
    response = await auth_api_client.get(f"{BASE_ROUTE}/blueprints/vpcs/{random_str}")
    assert response.status_code == status.HTTP_422_UNPROCESSABLE_ENTITY
...
async def test_blueprint_vpc_invalid_cidr(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_vpc_invalid_public_cidr(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_vpc_invalid_subnet_cidr(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_vpc_overlap_subnet_cidr(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_vpc_get_vpc(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_vpc_get_nonexistent_vpc(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_vpc_delete(auth_api_client: AsyncClient) -> None:
    ...
    # Delete VPC
    response = await auth_api_client.delete(f"{BASE_ROUTE}/blueprints/vpcs/{vpc_id}")
    assert response.status_code == status.HTTP_200_OK
...
async def test_blueprint_vpc_delete_invalid_id(auth_api_client: AsyncClient) -> None:
    """Test that we get a 422 when providing an invalid non-int ID."""
    random_str = "".join(
        random.choice(string.ascii_letters)  # noqa: S311
        for i in range(random.randint(1, 10))  # noqa: S311
...
async def test_blueprint_vpc_delete_non_existent(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_subnet_valid_payload(auth_api_client: AsyncClient) -> None:
...
async def test_blueprints_subnet_too_many_hosts(auth_api_client: AsyncClient) -> None:
...
async def test_blueprints_subnet_get_subnet(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_subnet_delete(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_subnet_delete_invalid_id(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_host_valid_payload(auth_api_client: AsyncClient) -> None:
    """Test that we get a 200 reponse and a valid ID in response."""
    response = await auth_api_client.post(
        f"{BASE_ROUTE}/blueprints/hosts", json=valid_blueprint_host_create_payload
    )
...
async def test_blueprint_host_get_host_invalid_id(auth_api_client: AsyncClient) -> None:
    """Test that we get a 422 when providing an invalid non-int ID."""
    response = await auth_api_client.post(
        f"{BASE_ROUTE}/blueprints/hosts", json=valid_blueprint_host_create_payload
    )
    ...
    response = await auth_api_client.get(f"{BASE_ROUTE}/blueprints/hosts/{random_str}")
    assert response.status_code == status.HTTP_422_UNPROCESSABLE_ENTITY
...
async def test_blueprint_host_get_host(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_host_duplicate_tags(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_host_long_tag(auth_api_client: AsyncClient) -> None:
...
async def test_user_cant_access_other_blueprints(
    api_client: AsyncClient, auth_api_client: AsyncClient
) -> None:
...
async def test_blueprint_host_delete(auth_api_client: AsyncClient) -> None:
...
async def test_blueprint_host_delete_invalid_id(auth_api_client: AsyncClient) -> None:
    """Test that we get a 422 when providing an invalid non-int ID."""
    random_str = "".join(
        random.choice(string.ascii_letters)  # noqa: S311
        for i in range(random.randint(1, 10))  # noqa: S311
...
async def test_blueprint_host_delete_non_existent(auth_api_client: AsyncClient) -> None:
...
async def test_user_delete_invalid_blueprint_range(
    ...
    # user2
    response = await api_client.delete(f"{BASE_ROUTE}/blueprints/ranges/{blueprint_id}")
    assert response.status_code == status.HTTP_404_NOT_FOUND
...
async def test_user_add_remove_vpc_blueprint_flow(
    ...
    response = await auth_api_client.get(f"{BASE_ROUTE}/blueprints/vpcs/{blueprint_id}")
    assert response.status_code == status.HTTP_200_OK
...
async def test_user_delete_invalid_blueprint_vpc(
    ...
    # user2
    response = await api_client.delete(f"{BASE_ROUTE}/blueprints/vpcs/{blueprint_id}")
    assert response.status_code == status.HTTP_404_NOT_FOUND
...
async def test_user_delete_invalid_blueprint_host(
    ...
    # user2
    response = await api_client.delete(f"{BASE_ROUTE}/blueprints/hosts/{blueprint_id}")
    assert response.status_code == status.HTTP_404_NOT_FOUND
